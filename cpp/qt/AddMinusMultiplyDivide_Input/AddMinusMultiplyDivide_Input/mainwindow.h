...
protected:
    ...
    void nextQuestion(bool currentCorrect, const QString& inputAnswer, const QString& modRestAnswer = QString() );
    void initUI();
...
/*const*/ int       m_maxQuestionCount;
    ...
    QString                   m_currentModAnswer; // for e.g.   9 / 4 = 2 ... 1

    int                       m_questionType; // 0: op1      1: op2      2: result
    bool                      m_bNeedInputMod;                                             
