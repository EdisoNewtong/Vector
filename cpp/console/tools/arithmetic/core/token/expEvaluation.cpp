...
ExpEvaluation::suffixExpEnv* ExpEvaluation::processOperatorStack(TokenBase* previousToken, const std::pair<TokenBase*,int>& tokenPair, ExpEvaluation::suffixExpEnv* currentEnv, const std::vector<TokenBase*>& expList)
{
