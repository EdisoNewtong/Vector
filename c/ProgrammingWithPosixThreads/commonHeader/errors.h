...
/*
 * Define a marco that can be used for diagnostic output from
 * examples. When compiled -DDEBUG, it results in calling printf with the specified argument list. When DEBUG is not defined, it 
 * expands to nothing
 */
 ...
 * allows the err_about and errno_about macros to be used as if they
