...
1. Thread #1 : 由于 Thread #2已经被阻塞，所以 CPU又将时间片给 Thread #1继续执行， 又执行了121次，共 9100+121=9221次后，在 95行处( pthread_mutex_unlock(...) 已经执行完毕了 )，时间片到期了，于是将执行权 交给 Thread #3来执行
